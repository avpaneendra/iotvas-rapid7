...
from iotvas import rest
from iotvas.configuration import Configuration
from iotvas.exceptions import ApiTypeError, ApiValueError, ApiException
from iotvas.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DeviceApi()
        api_instance.detect_device  # this is an instance of the class Endpoint
        api_instance.detect_device()  # this invokes api_instance.detect_device.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.detect_device.callable or self.callable in this class
