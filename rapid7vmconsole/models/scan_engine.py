...
class ScanEngine(object):
    ...
    def __init__(self, address=None, content_version=None, id=None, is_aws_pre_auth_engine=None, last_refreshed_date=None, last_updated_date=None, links=None, name=None, port=None, product_version=None, sites=None, status=None):  # noqa: E501
