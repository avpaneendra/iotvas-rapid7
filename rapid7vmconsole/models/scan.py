...
class Scan(object):
    ...
    def __init__(self, assets=None, duration=None, end_time=None, engine_id=None, engine_ids=None, engine_name=None, id=None, links=None, message=None, scan_name=None, scan_type=None, start_time=None, started_by=None, started_by_username=None, status=None, vulnerabilities=None):  # noqa: E501
